---
title: 'Llama'
description: 'Use Large Language Model Meta AI'
---

The Llama node allows you to integrate Meta's Llama models into your workflows.

The models available under this family are:

- ```Llama 3 8B - Groq```: The most capable openly available LLM to date, with a context window of 128K (equivalent of more than 300 pages of text in a single prompt).
- ```Llama 3 70B - Groq```: A bigger and better 'most capable openly available LLM to date'.

### Fields in Llama node
